...
export async function user() {
    render(html`
        <div class="container">
            ...
            <hr>
            <div class="container">
                <button id="add-user" type="button" class="btn btn-sm bgs-bluelight float-right mt-3 mb-3" style="width:50px"><i
                        class="fa fa-plus" aria-hidden="true"></i></button>
                <button id="edit-user" type="button" class="btn btn-sm bgs-bluelight float-right mt-3 mb-3"
                    style="width:50px"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                <button id="delete-user" type="button" class="btn btn-sm bgs-redlight float-right mt-3 mb-3"
        ...
        ajax: {
            ...
            dataSrc: function (result) {
                ...
                for (let index = 0; index < dataset.length; index++) {
                    ...
                    element.status_view = element.status === 0 ? '<p class="bg-warning rounded text-center text-white">Tidak Aktif</p>'
                        : element.status === 1 ? '<p class="bg-success rounded text-center text-white">Aktif</p>'
                            : '<p class="bg-danger rounded text-center text-white">Terblokir</p>'

                    element.type_view = element.type === 0 ? '<p class="bg-dark rounded text-center text-white">Developer</p>'
...
async function addUser() {
    swal.showModal('Ubah Data Karyawan', html`
